...
const addDivisiHp = async (data) => {
    const { nama_div_hp, nip_hp, foto_div_hp, tanggal_lahir, email, masa_jabatan, komentar_div_hp } = data;
    try {
        await db.query(
            'INSERT INTO divisi_hp (nama_div_hp, nip_hp, foto_div_hp, tanggal_lahir, email, masa_jabatan, komentar_div_hp) VALUES (?, ?, ?, ?, ?, ?, ?)',
            [nama_div_hp, nip_hp, foto_div_hp, tanggal_lahir, email, masa_jabatan, komentar_div_hp]
        );
    } catch (error) {
