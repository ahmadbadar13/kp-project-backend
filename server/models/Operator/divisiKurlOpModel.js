...
const addDivisiKurl = async (data) => {
    const { nama_div_kurl, nip_kurl, foto_div_kurl, tanggal_lahir, email, masa_jabatan, komentar_div_kurl } = data;
    try {
        await db.query(
            'INSERT INTO divisi_kurl (nama_div_kurl, nip_kurl, foto_div_kurl, tanggal_lahir, email, masa_jabatan, komentar_div_kurl) VALUES (?, ?, ?, ?, ?, ?, ?)',
            [nama_div_kurl, nip_kurl, foto_div_kurl, tanggal_lahir, email, masa_jabatan, komentar_div_kurl]
        );
    } catch (error) {
