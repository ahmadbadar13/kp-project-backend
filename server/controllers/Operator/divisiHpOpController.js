...
class DivisiHpController {
    // Create Data Divisi HP Operator
    static addDivisiHpOp(req, res) {
        const { name } = req.body;
    ...
    static getKomentarDivisiHpOp(req, res) {
    ...
    // Delete Komentar Divisi HP Operator
    static delKomentarDivisiHpOp(req, res) {
        const id = req.params.id;
...
module.exports = DivisiHpController;
