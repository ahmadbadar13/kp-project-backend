...
class SubBagianHsdmController {
    ...
    static addSubBagianHsdmOp(req, res) {
    ...
    static getSubBagianHsdmOp(req, res) {
    ...
    static updtSubBagianHsdmOp(req, res) {
        const { id } = req.params;
        const { name, nip, position } = req.body;
        const photo = req.file ? `/uploads/${req.file.filename}` : null;
    ...
    static delSubBagianHsdmOp(req, res) {
        const { id } = req.params;
    ...
    static getKomentarSubBagianHsdmOp(req, res) {
    ...
    static delKomentarSubBagianHsdmOp(req, res) {
        const id = req.params.id;
...
module.exports = SubBagianHsdmController;
